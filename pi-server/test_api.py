...
class PiServerApiTests(unittest.TestCase):
    ...
    def test_home_dashboard_is_single_bag_ui_with_polling_and_pair_code_card(self):
        ...
        self.assertIn('data-keyboard-submit-label="Connect"', body)
        ...
        self.assertIn("max-height: 126px;", body)
        self.assertIn("--wifi-modal-top: 0px;", body)
        self.assertIn("--wifi-modal-height: 0px;", body)
        self.assertIn("--wifi-keyboard-top: 0px;", body)
        ...
        self.assertIn("grid-template-rows: auto auto minmax(0, 1fr);", body)
        self.assertIn("body.keyboard-open .wifi-network-section {", body)
        self.assertIn("body.wifi-modal-open .wifi-modal {", body)
        self.assertIn("body.wifi-modal-open.keyboard-open .touch-keyboard {", body)
        self.assertIn("body.wifi-modal-open.keyboard-open .wifi-dialog {", body)
        self.assertIn("gap: 8px;", body)
        self.assertIn("padding: 10px 8px 8px;", body)
        self.assertIn("body.wifi-modal-open.keyboard-open {", body)
        self.assertIn("padding-bottom: 0;", body)
        self.assertIn("top: var(--wifi-keyboard-top, 0px);", body)
        self.assertIn("min-height: 24px;", body)
        ...
        self.assertIn("documentRoot.style.setProperty(\"--wifi-modal-height\"", body)
