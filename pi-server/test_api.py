...
class PiServerApiTests(unittest.TestCase):
    ...
    def test_home_dashboard_is_single_bag_ui_with_polling_and_pair_code_card(self):
        ...
        self.assertIn("GO BAG Command Center", body)
        ...
        self.assertIn('data-ui-scale-option="0"', body)
        self.assertIn('data-ui-scale-option="20"', body)
        self.assertIn('data-ui-scale-option="40"', body)
        self.assertIn('data-ui-scale-option="60"', body)
        self.assertIn('data-ui-scale-option="80"', body)
        self.assertIn('data-ui-scale-option="100"', body)
        ...
        self.assertNotIn('data-ui-scale-option="fit"', body)
